...
export default function EditPortfolio() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await adminApi.put(`/portfolio/${id}`, formData, {
            ...
            <div className={styles.formGrid}>
              ...
              <div className={styles.formGroup}>
                <ImageUpload
                  ...
                  onChange={(url: string) => setPortfolio({ ...portfolio, image: url })}
                  onFileChange={setSelectedFile}
                  label="Project Image"
                  placeholder="Upload project image (leave empty to keep current)"
                  folder="portfolio"
                />
              </div>
